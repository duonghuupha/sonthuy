<?php
class One_true extends Controller{
    ...
    function index(){
        $this->view->render('one_true/index');
    }
    ...
    function form(){
        ...
        $this->view->render('one_true/form');
    }
    ...
    function get_json_question(){
        ...
        $this->view->render('one_true/get_json_question');
    }
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function add($lesson_id, $code){
        for($i = 1; $i <= 4; $i++){
            ...
            $tmp = $this->_Data->addObj_one_true($data);
            if($tmp){
                if($file != ''){
    ...
    function update($lesson_id, $code){
        ...
        foreach($id_answer as $row){
            ...
            $tmp = $this->_Data->updateObj_one_true($row, $data);
            if($tmp){
