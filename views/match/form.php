                ...
                <tr id="row_<?php echo $row['id'] ?>">
                    <td style="width:45%;height:100px">
                        <form id="left_title_<?php echo $row['id'] ?>" method="post" enctype="multipart/form-data">
                            ...
                            placeholder="Nội dung" onchange="change_data_match(1, <?php echo $row['id'] ?>, 'left_title_', 1)" style="margin-bottom:7px;"/>
                        </form>
                        <form id="left_file_<?php echo $row['id'] ?>">
                            <input type="file" class="file_attach" name="file_left_<?php echo $row['id'] ?>" id="file_left_<?php echo $row['id'] ?>" style="width:100%;" onchange="change_data_match(2, <?php echo $row['id'] ?>, 'left_file_', 1)"/>
                        </form>
                        </td>
                    <td style="width:45%">
                        <form id="right_title_<?php echo $row['id'] ?>" method="post" enctype="multipart/form-data">
                            ...
                            placeholder="Nội dung" onchange="change_data_match(3, <?php echo $row['id'] ?>, 'right_title_', 1)" style="margin-bottom:7px;"/>
                        </form>
                        <form id="right_file_<?php echo $row['id'] ?>">
                            <input type="file" class="file_attach" name="file_right_<?php echo $row['id'] ?>" id="file_right_<?php echo $row['id'] ?>" style="width:100%;" onchange="change_data_match(4, <?php echo $row['id'] ?>, 'right_file_', 1)"/>
                        </form>
                        </td>
