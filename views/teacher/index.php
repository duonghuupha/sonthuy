        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12">
                    <table id="list_teacher" 
                        class="table" 
                        role="grid"
                        aria-describedby="dynamic-table_info"></table>
                    <div id="teacher_pager"></div>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.page-content -->
    </div>
...
<!--Form don vi tinh-->
<div id="modal-teacher" class="modal fade" data-keyboard="false" data-backdrop="static">
...
<script src="<?php echo URL.'/public/' ?>scripts/teacher/index.js"></script>