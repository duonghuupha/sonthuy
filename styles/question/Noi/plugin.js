(function($){
  $.fn.matchingQuiz = function(options){
    ...
    function renderQuiz(data){
      ...
      let $left = $('<div class="column left"><h3>Câu hỏi</h3></div>');
      let $right = $('<div class="column right"><h3>Đáp án</h3></div>');
      ...
      rightItems.forEach(a => {
        let $item = $('<div class="item"></div>').attr("data-id", a.id).text(a.text);
        $right.append($item);
      });
